...
func (ah *GinAuthHandler) Register(ctx context.Context, inputs *dtos.HumaReqBody[models.RegisterClientInput]) (*dtos.HumaResponse[dtos.GResp[bool]], error) {
	usr, err := ah.AdminAuthServ.RegisterWithEmail(ctx, inputs.Body)
	return dtos.HumaReturnG(usr, err)
}
func (ah *GinAuthHandler) VerifyRegisteredAccount(ctx context.Context, inputs *dtos.HumaReqBody[VerificationInput]) (*dtos.HumaResponse[dtos.GResp[bool]], error) {
...
func (ah *GinAuthHandler) ForgotPwd(ctx context.Context, inputs *dtos.HumaReqBody[VerifyReqInput]) (*dtos.HumaResponse[dtos.GResp[bool]], error) {
